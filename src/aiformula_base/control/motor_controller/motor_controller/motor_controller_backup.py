...
#  rpm = rpm * gear_ratio        [rpm]
    ...
    def toRefRPM(self, linear_velocity, angular_velocity):  # Calc Motor ref rad/s
        ...
        wheel_angular_velocities[DriveWheel.LEFT] = (
            ...
            # linear_velocity * (51.2025/50.0) / (self.diameter * 0.5)) - (self.tread / self.diameter) * angular_velocity  # [rad/s]
            # 51.16 : tarinai 2 tape
            # 51.18 : tarinai 2.5 tape
            # 51.20 : tarinai 3 tape

            # 51.205 : yarisugi 6 tape
            # 51.21 : yarisugi 6 tape
            # 51.22 : yarisugi 6 tape
            # 51.24 : yarisugi 6 tape
